...
const Filing = () => {
    ...
    const validateStep1 = () => {
        if (!filingState.period) {
            setFilingState(prev => ({ ...prev, errors: { period: 'Period is required' } }));
            return false;
        }
        const trnValidation = Validator.validateTRN(filingState.trn);
        if (!trnValidation.isValid) {
            setFilingState(prev => ({ ...prev, errors: { trn: trnValidation.errors[0] } }));
            return false;
        }
        return true;
    };
    const handleNext = () => {
        if (filingState.step === 1 && !validateStep1()) {
            return;
        }
        setFilingState(prev => ({ ...prev, step: prev.step + 1 }));
    };
    const handleBack = () => {
        setFilingState(prev => ({ ...prev, step: prev.step - 1 }));
    };
    const handleSubmit = () => {
        ...
        setFilingState(prev => ({ ...prev, showConfirmation: true }));
    };
    const saveDraft = () => {
    ...
    const renderStep1 = () => (_jsxs("div", { className: "space-y-4", children: [_jsx("h2", { className: "text-xl font-semibold", children: "Tax Filing Period" }), _jsxs("div", { children: [_jsx("label", { htmlFor: "period", className: "block text-sm font-medium text-gray-700", children: "Filing Period" }), _jsxs("select", { id: "period", value: filingState.period, onChange: e => setFilingState(prev => ({ ...prev, period: e.target.value })), className: "mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500", children: [_jsx("option", { value: "", children: "Select Period" }), _jsx("option", { value: "2024-Q1", children: "2024 Q1" }), _jsx("option", { value: "2024-Q2", children: "2024 Q2" })] }), filingState.errors.period && _jsx("p", { className: "mt-1 text-sm text-red-600", children: filingState.errors.period })] }), _jsxs("div", { children: [_jsx("label", { htmlFor: "trn", className: "block text-sm font-medium text-gray-700", children: "Tax Registration Number (TRN)" }), _jsx("input", { type: "text", id: "trn", value: filingState.trn, onChange: e => setFilingState(prev => ({ ...prev, trn: e.target.value })), className: "mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" }), filingState.errors.trn && _jsx("p", { className: "mt-1 text-sm text-red-600", children: filingState.errors.trn })] })] }));
