...
const Filing = () => {
    ...
    const revenueSources = useMemo(() => Array.from(new Set(taxState.revenue.map(r => r.source))), [taxState.revenue]);
        ...
        try {
            const submissionData = {
                ...
                data: {
                    ...
                    vatDue: taxState.revenue.reduce((sum, entry) => sum + entry.vatAmount, 0),
                    citDue: taxState.revenue.reduce((sum, entry) => sum + (entry.amount * 0.09), 0),
                    complianceScore: 100
                }
            };
    ...
    const renderStep2 = () => (_jsxs("div", { className: "space-y-4", children: [_jsx("h2", { className: "text-xl font-semibold", children: "Revenue Summary" }), _jsx("div", { className: "rounded-lg bg-white shadow", children: _jsx("div", { className: "px-4 py-5 sm:p-6", children: _jsxs("dl", { className: "grid grid-cols-1 gap-5 sm:grid-cols-2", children: [_jsxs("div", { children: [_jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Total Revenue" }), _jsxs("dd", { className: "mt-1 text-3xl font-semibold text-gray-900", children: [new Intl.NumberFormat('en-AE', {
                                            ...
                                            }).format(taxState.revenue.reduce((sum, r) => sum + r.amount, 0)), ' ', "AED"] })] }), _jsxs("div", { children: [_jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Total VAT" }), _jsxs("dd", { className: "mt-1 text-3xl font-semibold text-gray-900", children: [new Intl.NumberFormat('en-AE', {
                                                style: 'decimal',
                                                minimumFractionDigits: 0,
                                                maximumFractionDigits: 0
                                            }).format(taxState.revenue.reduce((sum, r) => sum + (r.vatAmount || 0), 0)), ' ', "AED"] })] })] }) }) })] }));
