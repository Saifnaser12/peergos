...
export const DashboardPage = () => {
    ...
    const filteredData = useMemo(() => {
        ...
        return {
            revenues: taxData.revenues.filter(r => r.date >= dateRange.startDate && r.date <= dateRange.endDate),
