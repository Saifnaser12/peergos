...
import { DocumentTextIcon, ReceiptPercentIcon, ChartBarIcon, CurrencyDollarIcon, ArrowRightIcon, BuildingOfficeIcon, ArrowTrendingUpIcon } from '@heroicons/react/24/outline';
const Dashboard = () => {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-900", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [_jsx("div", { className: "mb-8", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-4", children: [_jsx("div", { className: "p-3 bg-indigo-100 dark:bg-indigo-900/30 rounded-xl", children: _jsx(BuildingOfficeIcon, { className: "w-8 h-8 text-indigo-600 dark:text-indigo-400" }) }), _jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white", children: t('dashboard.title') }), _jsx("p", { className: "text-gray-600 dark:text-gray-400 mt-1", children: t('dashboard.subtitle') })] })] }), _jsxs("div", { className: "flex items-center space-x-4", children: [_jsx("span", { className: "inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400 border border-yellow-200 dark:border-yellow-700", children: t('fta.simulation.note') }), _jsx("button", { onClick: () => navigate('/assistant'), className: "inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-200", children: t('dashboard.askAssistant') })] })] }) }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8", children: summaryCards.map((card, index) => {
                    ...
                    }) }), _jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-8", children: [_jsx("div", { className: "px-6 py-4 border-b border-gray-200 dark:border-gray-700", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsxs("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white flex items-center", children: [_jsx(ArrowTrendingUpIcon, { className: "w-5 h-5 mr-2 text-green-500" }), t('dashboard.liveFinancials', 'Live Financial Summary'), isUpdating && (_jsx("div", { className: "ml-2 w-4 h-4 border-2 border-blue-500 border-t-transparent rounded-full animate-spin" }))] }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400 mt-1", children: t('dashboard.liveFinancialsSubtitle', 'Real-time data from your accounting entries') })] }), _jsxs("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: ["Last updated: ", new Date(summary.lastUpdated).toLocaleTimeString()] })] }) }), _jsx("div", { className: "p-6", children: _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [_jsx("div", { className: "text-center", children: _jsxs("div", { className: "bg-green-50 dark:bg-green-900/20 rounded-lg p-4", children: [_jsx(CurrencyDollarIcon, { className: "w-8 h-8 text-green-600 dark:text-green-400 mx-auto mb-2" }), _jsx("p", { className: "text-sm font-medium text-gray-600 dark:text-gray-400", children: t('financials.totalRevenue', 'Total Revenue') }), _jsxs("p", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: ["AED ", totalRevenue.toLocaleString()] })] }) }), _jsx("div", { className: "text-center", children: _jsxs("div", { className: "bg-red-50 dark:bg-red-900/20 rounded-lg p-4", children: [_jsx(ReceiptPercentIcon, { className: "w-8 h-8 text-red-600 dark:text-red-400 mx-auto mb-2" }), _jsx("p", { className: "text-sm font-medium text-gray-600 dark:text-gray-400", children: t('financials.totalExpenses', 'Total Expenses') }), _jsxs("p", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: ["AED ", totalExpenses.toLocaleString()] })] }) }), _jsx("div", { className: "text-center", children: _jsxs("div", { className: `${netIncome >= 0 ? 'bg-blue-50 dark:bg-blue-900/20' : 'bg-orange-50 dark:bg-orange-900/20'} rounded-lg p-4`, children: [_jsx(ChartBarIcon, { className: `w-8 h-8 ${netIncome >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'} mx-auto mb-2` }), _jsx("p", { className: "text-sm font-medium text-gray-600 dark:text-gray-400", children: t('financials.netIncome', 'Net Income') }), _jsxs("p", { className: `text-2xl font-bold ${netIncome >= 0 ? 'text-gray-900 dark:text-white' : 'text-orange-600 dark:text-orange-400'}`, children: ["AED ", netIncome.toLocaleString()] })] }) })] }) })] }), _jsx("div", { className: "mb-8", children: _jsx(FTAComplianceCenter, { trn: "100123456700003", revenue: totalRevenue }) }), _jsx("div", { className: "mb-8", children: _jsx(RealTimeTaxCalculator, {}) }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-8", children: [_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6", children: [_jsxs("div", { className: "mb-4", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white", children: t('fta.integration.title') }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400 mt-1", children: t('fta.integration.subtitle') })] }), _jsx(FTAIntegrationStatus, { trn: "100123456700003", variant: "card", showDetails: true })] }), _jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6", children: [_jsxs("div", { className: "mb-4", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white", children: t('trn.lookup.title') }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400 mt-1", children: t('trn.lookup.subtitle') })] }), _jsx(TRNLookup, { variant: "embedded" })] }), _jsx("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6", children: _jsx(POSIntegrationStatus, {}) })] }), _jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700", children: [_jsx("div", { className: "px-6 py-4 border-b border-gray-200 dark:border-gray-700", children: _jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white", children: t('dashboard.quickActions') }) }), _jsx("div", { className: "p-6", children: _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [_jsx("button", { onClick: () => navigate('/vat'), className: "flex items-center justify-center px-6 py-4 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg text-gray-900 dark:text-white font-medium transition-colors duration-200", children: t('dashboard.actions.fileVAT') }), _jsx("button", { onClick: () => navigate('/cit'), className: "flex items-center justify-center px-6 py-4 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg text-gray-900 dark:text-white font-medium transition-colors duration-200", children: t('dashboard.actions.calculateCIT') }), _jsx("button", { onClick: () => navigate('/financials'), className: "flex items-center justify-center px-6 py-4 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg text-gray-900 dark:text-white font-medium transition-colors duration-200", children: t('dashboard.actions.viewFinancials') }), _jsx("button", { onClick: () => navigate('/free-zone-substance'), className: "flex items-center justify-center px-6 py-4 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg text-gray-900 dark:text-white font-medium transition-colors duration-200", children: t('dashboard.actions.freeZoneSubstance') })] }) })] })] }) }));
};
