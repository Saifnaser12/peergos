...
import { Box, Typography, Paper, TextField, Button, IconButton, Card, CardContent, Alert, Snackbar, CircularProgress, Menu, MenuItem, Chip } from '@mui/material';
import { useTranslation } from 'react-i18next';
import { useNavigate } from 'react-router-dom';
import { PaperAirplaneIcon, DocumentArrowDownIcon, ShareIcon, SparklesIcon, QuestionMarkCircleIcon, ChatBubbleLeftRightIcon, ArrowPathIcon, DocumentDuplicateIcon, BeakerIcon } from '@heroicons/react/24/outline';
...
const Assistant = () => {
    ...
    const detectFilingIntent = (content) => {
        const citPatterns = [
    ...
    const handleDraftFiling = (message) => {
        if (!message.filingIntent)
            return;
...
- Keep responses clear, practical, and compliant with FTA guidance`;
    ...
    const exportAuditLog = () => {
        const auditContent = auditLogs.map(log => `[${log.timestamp.toISOString()}] Tokens: ${log.tokenUsage}, Response Time: ${log.responseTime}ms
...
---`).join('\n\n');
    ...
    return (_jsx(Box, { className: "min-h-screen bg-gray-50 dark:bg-gray-900", children: _jsxs("div", { className: "max-w-4xl mx-auto p-6", children: [_jsx(Paper, { elevation: 0, className: "p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm mb-6", children: _jsxs(Box, { className: "flex items-center justify-between mb-4", children: [_jsxs(Box, { className: "flex items-center gap-4", children: [_jsx("div", { className: "p-3 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl", children: _jsx(SparklesIcon, { className: "h-8 w-8 text-white" }) }), _jsxs(Box, { children: [_jsx(Typography, { variant: "h4", className: "text-gray-900 dark:text-white font-semibold", children: t('assistant.title', 'Tax Assistant') }), _jsx(Typography, { variant: "body1", className: "text-gray-600 dark:text-gray-400", children: t('assistant.subtitle', 'AI-powered guidance for UAE tax compliance') })] })] }), _jsxs(Box, { className: "flex items-center gap-3", children: [uaeMode && (_jsxs(Box, { className: "flex items-center gap-2 px-3 py-1 bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-full", children: [_jsx("span", { className: "text-lg", children: "\uD83C\uDDE6\uD83C\uDDEA" }), _jsx(Typography, { variant: "caption", className: "text-green-700 dark:text-green-300 font-medium", children: "CIT/VAT UAE Mode: Active" })] })), messages.length > 0 && (_jsxs(_Fragment, { children: [_jsx(IconButton, { onClick: clearChat, className: "text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200", children: _jsx(ArrowPathIcon, { className: "h-5 w-5" }) }), _jsx(IconButton, { onClick: (e) => setExportMenuAnchor(e.currentTarget), className: "text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200", children: _jsx(ShareIcon, { className: "h-5 w-5" }) })] }))] })] }) }), _jsxs(Paper, { className: "bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden", children: [_jsxs(Box, { className: "h-[500px] overflow-y-auto p-6 space-y-4", children: [messages.length === 0 ? (_jsx(Box, { className: "flex items-center justify-center h-full text-center", children: _jsxs(Box, { children: [_jsx(ChatBubbleLeftRightIcon, { className: "h-16 w-16 text-gray-300 dark:text-gray-600 mx-auto mb-4" }), _jsx(Typography, { variant: "h6", className: "text-gray-500 dark:text-gray-400 mb-2", children: t('assistant.welcome', 'Welcome to your Tax Assistant') }), _jsx(Typography, { variant: "body2", className: "text-gray-400 dark:text-gray-500", children: t('assistant.welcomeDesc', 'Ask questions about UAE tax compliance, or try a suggested question below') })] }) })) : (messages.map((message) => (_jsx(Box, { className: `flex ${message.type === 'user' ? (isRTL ? 'justify-start' : 'justify-end') : (isRTL ? 'justify-end' : 'justify-start')}`, children: _jsx(Box, { className: `max-w-[75%] rounded-2xl px-4 py-3 ${message.type === 'user'
                                            ...
                                            : 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white'}`, children: message.isTyping ? (_jsx(Box, { className: "flex items-center space-x-1", children: _jsxs("div", { className: "flex space-x-1", children: [_jsx("div", { className: "w-2 h-2 bg-gray-400 rounded-full animate-bounce" }), _jsx("div", { className: "w-2 h-2 bg-gray-400 rounded-full animate-bounce", style: { animationDelay: '0.1s' } }), _jsx("div", { className: "w-2 h-2 bg-gray-400 rounded-full animate-bounce", style: { animationDelay: '0.2s' } })] }) })) : (_jsxs(_Fragment, { children: [_jsx(Typography, { variant: "body1", className: "whitespace-pre-wrap", children: message.content }), message.filingIntent && message.filingIntent.confidence > 0.7 && (_jsxs(Box, { className: "mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800", children: [_jsxs(Box, { className: "flex items-center gap-2 mb-2", children: [_jsx(BeakerIcon, { className: "h-4 w-4 text-blue-600 dark:text-blue-400" }), _jsx(Typography, { variant: "caption", className: "text-blue-700 dark:text-blue-300 font-semibold uppercase tracking-wide", children: t('assistant.draftFiling.detected', 'Draft Filing Detected') }), _jsx(Chip, { label: `🧪 ${message.filingIntent.type}`, size: "small", className: "bg-blue-100 dark:bg-blue-800 text-blue-700 dark:text-blue-200" })] }), _jsx(Typography, { variant: "body2", className: "text-blue-600 dark:text-blue-300 mb-3", children: message.filingIntent.type === 'CIT'
                                                                ...
                                                                : t('assistant.draftFiling.vatDetected', 'I detected VAT filing information in my response. Would you like to simulate a draft filing?') }), _jsx(Button, { variant: "contained", size: "small", startIcon: _jsx(DocumentDuplicateIcon, { className: "h-4 w-4" }), onClick: () => handleDraftFiling(message), className: "bg-blue-600 hover:bg-blue-700 text-white", children: t('assistant.draftFiling.simulate', `Simulate ${message.filingIntent.type} Filing`) })] })), _jsx(Typography, { variant: "caption", className: `block mt-2 ${message.type === 'user'
                                                        ? 'text-indigo-100'
                                                        : 'text-gray-500 dark:text-gray-400'}`, children: message.timestamp.toLocaleTimeString() })] })) }) }, message.id)))), _jsx("div", { ref: messagesEndRef })] }), _jsx(Box, { className: "border-t border-gray-200 dark:border-gray-700 p-4", children: _jsxs(Box, { className: "flex gap-3 items-end", children: [_jsx(TextField, { fullWidth: true, multiline: true, maxRows: 3, variant: "outlined", placeholder: t('assistant.input.placeholder', 'Ask about VAT, CIT, Transfer Pricing, or general tax questions...'), value: input, onChange: (e) => setInput(e.target.value), onKeyPress: (e) => {
                                            if (e.key === 'Enter' && !e.shiftKey) {
                                                e.preventDefault();
                                                handleSend();
                                            }
                                        }, disabled: isLoading, className: "bg-gray-50 dark:bg-gray-700", sx: {
                                        ...
                                        } }), _jsx(Button, { variant: "contained", onClick: handleSend, disabled: isLoading || !input.trim(), className: "bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 px-6 py-3 rounded-xl", endIcon: isLoading ? _jsx(CircularProgress, { size: 16, color: "inherit" }) : _jsx(PaperAirplaneIcon, { className: "h-5 w-5" }), children: t('assistant.input.send', 'Send') })] }) })] }), _jsxs(Paper, { elevation: 0, className: "p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm mt-6", children: [_jsx(Typography, { variant: "h6", className: "text-gray-900 dark:text-white mb-4 font-semibold", children: t('assistant.suggestions.title', 'Suggested Questions') }), _jsx(Box, { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: suggestedQuestions.map((suggestion) => (_jsx(Card, { className: "cursor-pointer hover:shadow-md transition-all duration-200 hover:scale-[1.02] border border-gray-200 dark:border-gray-700", onClick: () => handleSuggestionClick(suggestion), children: _jsx(CardContent, { className: "p-4", children: _jsxs(Box, { className: "flex items-start gap-3", children: [_jsx(QuestionMarkCircleIcon, { className: `h-6 w-6 mt-1 ${getCategoryColor(suggestion.category)}` }), _jsxs(Box, { className: "flex-1", children: [_jsx(Typography, { variant: "body1", className: "text-gray-900 dark:text-white font-medium mb-1", children: suggestion.question }), _jsx(Typography, { variant: "caption", className: `uppercase tracking-wide font-semibold ${getCategoryColor(suggestion.category)}`, children: t(`assistant.categories.${suggestion.category}`, suggestion.category) })] })] }) }) }, suggestion.id))) })] }), _jsxs(Menu, { anchorEl: exportMenuAnchor, open: Boolean(exportMenuAnchor), onClose: () => setExportMenuAnchor(null), children: [_jsxs(MenuItem, { onClick: exportChat, children: [_jsx(DocumentArrowDownIcon, { className: "h-5 w-5 mr-2" }), t('assistant.export.chat', 'Export Chat')] }), _jsxs(MenuItem, { onClick: exportAuditLog, children: [_jsx(DocumentArrowDownIcon, { className: "h-5 w-5 mr-2" }), t('assistant.export.auditLog', 'Export Audit Log')] })] }), _jsx(Snackbar, { open: !!error, autoHideDuration: 6000, onClose: () => setError(null), anchorOrigin: { vertical: 'bottom', horizontal: 'right' }, children: _jsx(Alert, { severity: "error", onClose: () => setError(null), children: error }) }), _jsx(Snackbar, { open: !!success, autoHideDuration: 3000, onClose: () => setSuccess(null), anchorOrigin: { vertical: 'bottom', horizontal: 'right' }, children: _jsx(Alert, { severity: "success", onClose: () => setSuccess(null), children: success }) })] }) }));
};
