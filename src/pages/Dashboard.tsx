    ...
    <Box>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6">VAT Status</Typography>
            <Typography variant="body2">Current filing status</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6">CIT Status</Typography>
            <Typography variant="body2">Corporate tax status</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6">Compliance</Typography>
            <Typography variant="body2">Overall compliance status</Typography>
          </Paper>
        </Grid>
      </Grid>
    </Box>
