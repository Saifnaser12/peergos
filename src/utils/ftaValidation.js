...
const calculateTRNCheckDigit = (trnPrefix) => {
    let sum = 0;
...
export const validateTaxInvoice = (invoice) => {
    const errors = [];
    const warnings = [];
...
export const validateVATReturn = (vatReturn) => {
    const errors = [];
    const warnings = [];
    // TRN validation
...
export const validateCITReturn = (citReturn) => {
    const errors = [];
    const warnings = [];
    // TRN validation
...
export const validateBusinessRules = (data, entityType) => {
    const errors = [];
    const warnings = [];
    switch (entityType) {
        case 'INVOICE':
...
export const performComplianceCheck = (data, entityType) => {
