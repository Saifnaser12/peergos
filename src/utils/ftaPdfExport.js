...
class FTAPDFExporter {
    constructor(t, isRTL = false) {
        ...
        Object.defineProperty(this, "isRTL", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    addCompanySection(companyInfo, yPosition) {
    ...
    addDeclarationSection(yPosition) {
    ...
    generateCITPDF(companyInfo, citData) {
    ...
    generateVATPDF(companyInfo, vatData) {
        const pdf = new jsPDF();
    ...
    generateFinancialsPDF(companyInfo, financialData) {
