...
export const mockCompanyDatabase: Record<string, MockCompanyData> = {
  '100346598400003': {
    trn: '100346598400003',
...
export const validateTRN = async (trn: string): Promise<MockCompanyData | null> => {
  // Simulate API delay
...
export const checkFTAIntegrationStatus = (trn: string): {
...
export const simulateFileUpload = async (file: File, type: 'tax_agent' | 'payment_slip', trn: string): Promise<{
  success: boolean;
  fileName: string;
  uploadDate: string;
}> => {
