...
export function generatePhase2InvoiceXML(invoice) {
...
export function downloadInvoiceXML(invoiceData) {
...
export function downloadPhase2InvoiceXML(invoice, filename) {
