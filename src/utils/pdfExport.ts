...
import { BalanceSheet, Account } from '../types/financials';
...
const createAccountRows = (accounts: Account[]): TableRow[] => {
...
export const generateBalanceSheetPDF = (
  ...
  doc.text(
    `${t('balanceSheet.totalLiabilities')} + ${t('balanceSheet.equity')}: ${formatCurrency(
