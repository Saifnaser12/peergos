...
export const InvoiceForm = ({ initialInvoice, onSubmit, onCancel }) => {
    ...
    const [freeZoneVATNote, setFreeZoneVATNote] = useState(null);
    const calculateFreeZoneVAT = (isFreeZoneCompany, customerLocation) => {
        let vatNote = null;
    ...
    return (_jsxs(Box, { component: "form", onSubmit: handleSubmit, children: [_jsx(Card, { sx: { mb: 3 }, children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "Basic Information" }), _jsxs(Grid, { container: true, spacing: 2, children: [_jsx(Grid, { item: true, xs: 12, md: 6, children: _jsx(TextField, { fullWidth: true, label: "Invoice Number", value: invoice.invoiceNumber, onChange: (e) => handleInputChange('invoiceNumber', e.target.value), required: true }) }), _jsx(Grid, { item: true, xs: 12, md: 6, children: _jsx(TextField, { fullWidth: true, type: "date", label: "Issue Date", value: invoice.issueDate.split('T')[0], onChange: (e) => handleInputChange('issueDate', e.target.value), InputLabelProps: { shrink: true } }) })] })] }) }), _jsx(Card, { sx: { mb: 3 }, children: _jsxs(CardContent, { children: [_jsx(Typography, { variant: "h6", gutterBottom: true, children: "Free Zone Configuration" }), _jsxs(Grid, { container: true, spacing: 2, children: [_jsx(Grid, { item: true, xs: 12, md: 6, children: _jsxs(TextField, { fullWidth: true, select: true, label: "Is this a Free Zone company?", value: invoice.isFreeZoneCompany ? 'true' : 'false', onChange: (e) => {
                                        ...
                                        }, SelectProps: { native: true }, children: [_jsx("option", { value: "false", children: "No" }), _jsx("option", { value: "true", children: "Yes" })] }) }), _jsx(Grid, { item: true, xs: 12, md: 6, children: _jsxs(TextField, { fullWidth: true, select: true, label: "Customer Location", value: invoice.customerLocation || 'UAE_MAINLAND', onChange: (e) => {
