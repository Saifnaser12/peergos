...
export const InvoiceDashboard = () => {
    ...
    return (_jsxs(Box, { p: 3, children: [_jsx(Typography, { variant: "h4", gutterBottom: true, children: "Invoice Dashboard" }), _jsx(Card, { sx: { mb: 3 }, children: _jsx(CardContent, { children: _jsxs(Grid, { container: true, spacing: 3, sx: { alignItems: 'center' }, children: [_jsx(Grid, { item: true, xs: 12, sm: 4, children: _jsx(Box, { children: _jsxs(TextField, { select: true, fullWidth: true, label: "Status", value: filters.status, onChange: handleStatusChange, children: [_jsx(MenuItem, { value: "", children: "All" }), Object.values(InvoiceStatus).map(status => (_jsx(MenuItem, { value: status, children: status }, status)))] }) }) }), _jsx(Grid, { item: true, xs: 12, sm: 4, children: _jsx(Box, { children: _jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: _jsx(DatePicker, { label: "Start Date", value: filters.startDate, onChange: handleStartDateChange, slotProps: { textField: { fullWidth: true } } }) }) }) }), _jsx(Grid, { item: true, xs: 12, sm: 4, children: _jsx(Box, { children: _jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: _jsx(DatePicker, { label: "End Date", value: filters.endDate, onChange: handleEndDateChange, slotProps: { textField: { fullWidth: true } } }) }) }) })] }) }) }), _jsx(TableContainer, { component: Paper, children: _jsxs(Table, { children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [_jsx(TableCell, { children: "Invoice Number" }), _jsx(TableCell, { children: "Issue Date" }), _jsx(TableCell, { children: "Amount" }), _jsx(TableCell, { children: "Status" }), _jsx(TableCell, { align: "right", children: "Actions" })] }) }), _jsx(TableBody, { children: loading ? (_jsx(TableRow, { children: _jsx(TableCell, { colSpan: 5, align: "center", children: "Loading..." }) })) : invoices.length === 0 ? (_jsx(TableRow, { children: _jsx(TableCell, { colSpan: 5, align: "center", children: "No invoices found" }) })) : (invoices.map((invoice) => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: invoice.invoiceNumber }), _jsx(TableCell, { children: format(new Date(invoice.issueDate), 'dd/MM/yyyy') }), _jsx(TableCell, { children: invoice.total.toLocaleString('en-AE', {
                                            style: 'currency',
                                            currency: 'AED'
