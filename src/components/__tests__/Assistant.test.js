...
const MockProviders = ({ children }) => (_jsx(BrowserRouter, { children: _jsx(I18nextProvider, { i18n: i18n, children: _jsx(TaxProvider, { children: _jsx(FinanceProvider, { children: children }) }) }) }));
describe('AI Assistant Production Testing', () => {
    ...
    describe('Context Injection', () => {
        it('should inject TRN and financial data into assistant context', async () => {
            render(_jsx(MockProviders, { children: _jsx(Assistant, {}) }));
