...
describe('Filing Flow Integration', () => {
    ...
    it('completes the full filing flow', async () => {
        ...
        expect(SecureStorage.set).toHaveBeenCalledWith('filings', expect.arrayContaining([
    ...
    it('saves draft filing', async () => {
        ...
        // Verify draft saved
        expect(SecureStorage.set).toHaveBeenCalledWith('draftFiling', expect.objectContaining({
            period: '2024-Q1',
